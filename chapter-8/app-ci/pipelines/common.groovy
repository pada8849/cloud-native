  ...
  - name: kaniko
    ...
    volumeMounts:
      - name: workspace-volume
        mountPath: /home/jenkins/agent
  - name: build
    image: ${REGISTRY}/library/build:init
    command:
    - cat
    tty: true
    volumeMounts:
...
"""
    ...
    node(POD_LABEL)  {
        ...
        gitopsfile = "https://devops.cn-hangzhou.aliyuncs.com/api/v3/projects/[ProjectId]/repository/files/${CLUSTER}/${JOB_NAME}-deploy.yaml"
